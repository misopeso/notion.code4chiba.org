...
import Heading from '../partials/page/heading'
...
// Get the data for each notion post
export async function getStaticProps({ params: { slug }, preview }) {
  ...
  // viewed without preview mode then we just redirect to /notion
...
// Return our list of notion posts to prerender
